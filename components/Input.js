...
const Input = () => {
    ...
    const [modalType , setModalType] = useRecoilState(modalTypeState)
     ...
     return (
    <div className={`${darkMode ? 'bg-[#1D2226] border-none' : 'bg-white'} rounded-lg p-3 space-y-3 border border-gray-300`}>
        ...
        <div className='flex items-center flex-wrap gap-y-4 justify-center md:gap-x-10'>
            ...
            <button className="inputButton group">
              ...
              <h4 className='opacity-80 group-hover:opacity-100 whitespace-nowrap'>Write Aticle</h4>
            </button>
        </div>
    </div>
  )
